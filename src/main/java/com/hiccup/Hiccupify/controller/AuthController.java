...
import com.hiccup.Hiccupify.request.LoginRequest;
import com.hiccup.Hiccupify.response.ApiResponse;
import com.hiccup.Hiccupify.response.JwtResponse;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> login( @RequestBody LoginRequest request){
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ApiResponse("Login Failed", e.getMessage()));
        }
    }
}
